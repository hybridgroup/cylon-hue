...
Adaptor.prototype.turnOn = function(lightId) {
	this.setLightState(lightId, {"on": true});
}

Adaptor.prototype.turnOff = function(lightId) {
	this.setLightState(lightId, {"on": false});
}
